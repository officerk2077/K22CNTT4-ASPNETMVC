...
namespace NtkLesson07Df.Controllers
{
    ...
    {
        private NtkK22CNT4Lesson07DbEntities db = new NtkK22CNT4Lesson07DbEntities();

        // GET: NtkKhoas
        public ActionResult NtkIndex()
        {
            return View(db.ntkKhoa.ToList());
        }
        ...
        public ActionResult NtkDetails(string id)
        {
            ...
            ntkKhoa ntkKhoa = db.ntkKhoa.Find(id);
            if (ntkKhoa == null)
            {
                return HttpNotFound();
            }
